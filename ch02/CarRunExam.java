...
public class CarRunExam {
	...
	public static void main(String[] args) {
		...
		int speed = 0 ; // 차량 속도
		final int MAXSPEED = 300 ; // 최고속도 상수 (변경 안됨)
		final int MINSPEED = 0 ;  //  최저속도 상수 (변경 안됨)
		
		System.out.println("람보르기니가 입고되었습니다.");
		System.out.println("시동을 켭니다.");
		System.out.println("현재 속도 " + speed + "km/h");
		
		while(run) { //무한반복중 메뉴가 출력
			System.out.println("=============="); // 종료 성공
			System.out.println("0. 시동 종료"); // 30키로 가속 + 300이하 최대 성공
